...
RUN comfy model download --url https://huggingface.co/ezioruan/inswapper_128.onnx/resolve/main/inswapper_128.onnx --relative-path models/checkpoints --filename inswapper_128.onnx
